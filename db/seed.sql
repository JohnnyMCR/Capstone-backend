...
VALUES
  ...
  (4, 2, 'Hello! I completely relate to your situation as a single parent. One thing thats worked for me is setting clear boundaries between work and home life. This way, I can fully focus on quality time with my child when Im with them. Its also helpful to establish a routine that includes designated us time during the week, whether its playing board games, taking short walks, or even just sharing stories. Keep up the good work!', '2023-09-21'),
  (4, 3, 'Hi there! As a single mom, Ive faced similar challenges. One strategy thats helped me is finding local parenting groups or clubs where my child can engage in activities they love while I connect with other single parents. Its a win-win for bonding and socializing. Additionally, consider a flexible work schedule if possible to free up more time during the day for special moments with your child. Hang in there, youre doing great!', '2023-09-21');
